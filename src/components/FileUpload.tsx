...
export const FileUpload: React.FC<FileUploadProps> = ({ 
  ...
  useEffect(() => {
    // Only notify parent when all files have finished their validation/thumbnail phase.
    // Firing during isValidating would cause parent components to re-process the file
    // list mid-operation, triggering progress bar resets and erratic behavior.
    const allReady = files.every(f => !f.isValidating);
    if (allReady) {
    ...
    <div className="w-full space-y-6">
      ...
      <div
        ...
        className={cn(
          ...
          isDragging 
            ? "border-indigo-600 bg-indigo-50/50 scale-[1.02] shadow-2xl shadow-indigo-500/10" 
      ...
      >
        ...
        <div className={cn(
          "relative z-10 p-5 rounded-[1.5rem] transition-all duration-500 pointer-events-none",
